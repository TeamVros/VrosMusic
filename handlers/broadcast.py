# Copyright (C) 2021 By VrosProject
...
from callsmusic.callsmusic import client as vros
...
async def broadcast(_, message: Message):
    ...
    if message.from_user.id not in SUDO_USERS:
        ...
        async for dialog in vros.iter_dialogs():
            try:
                await vros.send_message(dialog.chat.id, lmao)
                sent = sent+1
